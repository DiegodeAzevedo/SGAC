...
rule_condition = Function('rule_condition', rules, BoolSort(), BoolSort())
...
'''
conRule = Function('conRule', BoolSort(), rules, BoolSort())  # Creating of the variable ConRule
auxCon = Const('auxCon', BoolSort())
auxRule1 = Const('auxRule1', rules)
...
if s.check() == sat:
    print("RULE")
    print(s.model()[rule_condition])
    print(s.model()[lessSpecific])
    print(s.model()[conRule])
    print(s.model()[applicable])
    print(s.model()[xx])
    print(s.model()[yy])
    print(s.model().eval(c0))
    print(s.model().eval(c1))
    print(s.model().eval(c2))

    f = open("model_con_modif.txt", "w+")
